                ...
                <tbody>
                    {users.map((user) => (
                        ...
                        >
                            ...
                            <td className="px-5 py-4 relative text-left">
                                {isCEOView ? (
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                                        ...
                                        className="text-[#1428AE] hover:underline p-0 h-auto bg-transparent border-none text-[14px] font-normal transition-none"
                                    >
                                        View Profile
                                    </button>
                                ) : (
