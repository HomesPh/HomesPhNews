function Div() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[7px] items-center relative shrink-0 w-full" data-name="div">
      ...
      <div className="css-g0mm18 flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#bb4d20] text-[12px] tracking-[-0.5px]">
        <p className="css-ew64yg leading-[normal]">22</p>
      </div>
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[normal] not-italic relative shrink-0 text-[#bb4d20] text-[12px] tracking-[-0.5px] w-[159px]">
...
export default function Div1() {
  return (
    <div className="bg-[#fef3c6] content-stretch flex flex-col items-start justify-center px-[12px] py-[10px] relative rounded-[6px] size-full" data-name="div">
