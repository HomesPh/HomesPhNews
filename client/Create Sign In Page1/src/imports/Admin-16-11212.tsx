import svgPaths from "./svg-cmp8z7x0tu";
...
function Button2() {
  return (
    <div className="bg-[#c10008] content-stretch flex h-full items-center justify-center px-[20px] py-[11px] relative rounded-[8px] shrink-0" data-name="button">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[-0.5px]">Week</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#f3f4f6] content-stretch flex h-full items-center justify-center px-[20px] py-[11px] relative rounded-[8px] shrink-0" data-name="button">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[14px] not-italic relative shrink-0 text-[#374151] text-[14px] text-center tracking-[-0.5px]">Month</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-white content-stretch flex gap-[31px] h-full items-center justify-center px-[14px] py-[12px] relative rounded-[8px] shrink-0 w-[160px]" data-name="button">
      <div aria-hidden="true" className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[14px] not-italic relative shrink-0 text-[#111827] text-[14px] text-center tracking-[-0.5px] w-[79px]">01/21/2026</p>
      <div className="h-[12px] relative shrink-0 w-[11px]" data-name="Icon">
        <div className="absolute inset-[-4.17%_-4.55%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 13">
            <path d={svgPaths.p30cce000} id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      </div>
    </div>
...
function Div27() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-2 border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">SUN</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">28</p>
        </div>
      </div>
    </div>
  );
...
function Div28() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">MON</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">29</p>
        </div>
      </div>
    </div>
  );
...
function Div29() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">TUE</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">30</p>
        </div>
      </div>
    </div>
  );
...
function Div30() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">WED</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">31</p>
        </div>
      </div>
    </div>
  );
...
function Div31() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">THU</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">1</p>
        </div>
      </div>
    </div>
  );
...
function Div32() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">FRI</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">2</p>
        </div>
      </div>
    </div>
  );
...
function Div33() {
  return (
    <div className="bg-[#f9fafb] flex-[1_0_0] h-[92px] min-h-px min-w-px relative" data-name="div">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center justify-between not-italic px-[16px] py-[20px] relative size-full text-center">
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] relative shrink-0 text-[#6b7280] text-[12px] tracking-[0.1px]">SAT</p>
          <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#111827] text-[24px] tracking-[-0.5px]">3</p>
        </div>
      </div>
    </div>
  );
...
function Div26() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-center relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <Div27 />
      <Div28 />
      <Div29 />
...
function Div35() {
  return (
    <div className="bg-white flex-[1_0_0] h-[500px] min-h-px min-w-px relative" data-name="div">
...
function Div41() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[15px] text-black tracking-[-0.5px]">🎉</p>
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[14px] justify-center leading-[0] not-italic relative shrink-0 text-[#111827] text-[14px] tracking-[-0.5px] w-[99px]">
...
function Div40() {
  return (
    <div className="bg-[#f1f5f9] h-[56px] relative rounded-[6px] shrink-0 w-full" data-name="div">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start justify-center px-[12px] py-[10px] relative size-full">
          <Div41 />
          <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[12px] not-italic relative shrink-0 text-[#6b7280] text-[12px] tracking-[-0.5px]">All Day</p>
        </div>
      </div>
    </div>
  );
...
function Div39() {
  return (
    <div className="bg-white flex-[1_0_0] h-[500px] min-h-px min-w-px relative" data-name="div">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[20px] items-start px-[14px] py-[16px] relative size-full">
        <Div40 />
        <Div42 />
        <Div44 />
        <Div46 />
...
function Admin1() {
  return (
    <div className="absolute bg-white left-0 rounded-[8px] top-[2px]" data-name="Admin">
    ...
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-px relative w-full">
          <div className="css-g0mm18 flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[46px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[16px] text-black text-ellipsis tracking-[-0.5px] w-[141px]">
...
function Input2() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-px relative w-full">
          <div className="css-g0mm18 flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[46px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[16px] text-black text-ellipsis tracking-[-0.5px] w-[147px]">
...
function Div56() {
  return (
    <div className="bg-[rgba(0,0,0,0)] h-[245px] relative shrink-0 w-full" data-name="div">
...
function Div53() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-[420px] rounded-[16px] top-[211px] w-[600px]" data-name="div">
...
function Div52() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.4)] border-0 border-[#e5e7eb] border-solid h-[949px] left-0 overflow-clip top-0 w-[1440px]" data-name="div">
      <Div53 />
    </div>
  );
}
