...
class NewsScraper:
    ...
    def fetch_news(self, keyword, country, use_cache=True, prefer_direct=False):
        """
        Fetches news from Google News RSS.
        Uses cache if available to prevent lag.
        """
        # Removed global direct feeds (like CNN) because it causes massive duplicates 
        # across different countries and ignores the localized "Filipino" search query.
