...
interface EditPartnerSiteModalProps {
  site: Site;
  onClose: () => void;
  onSave: (updatedSite: Site) => void;
}

export function EditPartnerSiteModal({ site, onClose, onSave }: EditPartnerSiteModalProps) {
  ...
  const contactInfo = extractContact(site.contact);
  ...
  const handleSubmit = () => {
    const updatedSite: Site = {
      ...
      image: formData.logoUrl || formData.logo
    };
    onSave(updatedSite);
    onClose();
  };
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-[#d1d5db] rounded-[8px] text-[14px] text-[#111827] placeholder:text-[#adaebc] focus:outline-none focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent tracking-[-0.5px]"
              />
              <p className="text-[12px] text-[#6b7280] mt-1 tracking-[-0.5px]">
