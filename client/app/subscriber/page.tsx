...
/**
 * SubscriberDashboard - Overview page for subscribers
 */
export default function SubscriberDashboard() {
    ...
    useEffect(() => {
        ...
        if (storedUserInfo) {
            ...
            setUserName(user.firstName || "Subscriber");
        }
                    ...
                    <div className="space-y-4">
                        {isLoading ? (
                            ...
                            <div className="p-10 text-center bg-white rounded-lg border border-dashed border-gray-200">
                                <p className="text-gray-500 font-medium tracking-[-0.5px]">No published articles yet.</p>
                            </div>
                        )}
                    </div>
                </div>
