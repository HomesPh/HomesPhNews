import svgPaths from "./svg-tt0jyiyqye";
...
function Button8() {
  return (
    <div className="bg-[#dc2626] h-[46.5px] relative rounded-[8px] shrink-0 w-[137.391px]" data-name="button">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_2px_4px_0px_rgba(220,38,38,0.2),0px_4px_6px_0px_rgba(220,38,38,0.2)]" />
      <p className="absolute css-4hzbpn font-['Inter:Medium',sans-serif] font-medium leading-[15px] left-[68.7px] not-italic text-[15px] text-center text-white top-[13px] tracking-[-0.5px] translate-x-[-50%] w-[143.391px]">Add Event</p>
    </div>
  );
}
...
function Div27() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] content-stretch flex flex-col h-[295px] items-center justify-between px-0 py-[70px] relative shrink-0 w-full" data-name="div">
      ...
      <div className="h-[49px] relative shrink-0 w-[44px]" data-name="Icon">
        <div className="absolute inset-[-5.1%_-5.68%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 49 54">
            <path d={svgPaths.p1e109880} id="Icon" stroke="var(--stroke-0, #D1D5DB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" />
          </svg>
        </div>
      </div>
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#6b7280] text-[16px] tracking-[-0.5px]">No events scheduled for this day</p>
      <Button8 />
    </div>
  );
}
