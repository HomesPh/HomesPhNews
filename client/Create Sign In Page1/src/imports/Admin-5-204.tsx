import svgPaths from "./svg-fraeet99xw";
...
function Button2() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex gap-[12px] h-[48px] items-center justify-center px-[20px] py-0 relative rounded-[8px] shrink-0 w-[313px]" data-name="button">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="h-[12px] relative shrink-0 w-[16px]" data-name="Icon">
        <div className="absolute inset-[-10.42%_-7.81%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.5 14.5">
            <g id="Icon">
              <path d={svgPaths.p318cd7f0} stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="2.5" />
              <path d={svgPaths.p55cfc00} stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.7" strokeWidth="2.5" />
            </g>
          </svg>
        </div>
      </div>
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-black tracking-[-0.5px]">{` View on Portal`}</p>
    </div>
  );
}
