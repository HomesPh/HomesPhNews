    ...
    useEffect(() => {
        if (!isLoaded && data) {
            ...
            const initialDetails = {
                ...
                authorTitle: "",
                publishDate: (data.publishDate ? data.publishDate.split(' ')[0] : new Date().toISOString().split('T')[0]),
                publishTime: (data.publishDate && data.publishDate.includes(' ') ? data.publishDate.split(' ')[1].substring(0, 5) : (data.publishTime || "12:00")),
