...
// Restaurants (Public)
Route::get('/restaurants', [\App\Http\Controllers\Api\User\RestaurantController::class , 'index']);
Route::get('/restaurants/{id}', [\App\Http\Controllers\Api\User\RestaurantController::class , 'show']);
