        ...
        <div className="flex items-center gap-4 p-5 border-b border-[#e5e7eb] bg-white">
            ...
            <div className="relative min-w-[159px]">
                <select
                    ...
                    className="w-full h-[50px] pl-3 pr-10 border border-[#d1d5db] rounded-[8px] text-[16px] text-[#111827] bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-[#C10007] focus:border-transparent tracking-[-0.5px] cursor-pointer"
                >
