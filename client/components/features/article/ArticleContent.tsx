                  ...
                  <div className="mb-10">
                    ...
                    {(type === 'left-image' || type === 'right-image') && (
                      <div className={cn(
                        ...
                        <div
                          style={blockStyle}
                          className={cn("whitespace-pre-wrap flex-1 text-[18px] leading-[34px] tiptap [&_p]:min-h-[1.5em] [&_ul]:list-disc [&_ul]:pl-10 [&_ol]:list-decimal [&_ol]:pl-10 [&_li]:mb-1", darkClass("text-[#0c0c0c] dark:text-gray-200"))}
                          dangerouslySetInnerHTML={{ __html: decodeHtml(bContent?.text || bContent || '') }}
                        />
                      </div>
                    )}
                    ...
                    {(type === 'split-left' || type === 'split-right') && (
                      <div className={cn(
                        ...
                        <div
                          style={blockStyle}
                          className={cn("whitespace-pre-wrap flex-1 p-10 md:p-14 flex items-center text-[22px] leading-[1.4] font-medium tracking-tight tiptap [&_p]:min-h-[1.5em] [&_ul]:list-disc [&_ul]:pl-10 [&_ol]:list-decimal [&_ol]:pl-10 [&_li]:mb-1", darkClass("text-[#111827] dark:text-white"))}
                          dangerouslySetInnerHTML={{ __html: decodeHtml(bContent?.text || bContent || '') }}
                        />
                      </div>
                    )}
