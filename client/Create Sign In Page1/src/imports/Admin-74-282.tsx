import svgPaths from "./svg-fg5j1bcz1d";
...
function Button1() {
  return (
    <div className="bg-[#c10008] content-stretch flex h-full items-center justify-center px-[20px] py-[11px] relative rounded-[8px] shrink-0" data-name="button">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[-0.5px]">Day</p>
    </div>
  );
}
...
function Div24() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <p className="css-4hzbpn font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[12px] not-italic relative shrink-0 text-[#6b7280] text-[16px] text-center tracking-[0.1px] w-[171.859px]">MON</p>
    </div>
  );
}
...
function Div25() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex h-[35px] items-center justify-center px-0 py-px relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <p className="css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#111827] text-[45px] text-center tracking-[-0.5px] w-[171.859px]">29</p>
    </div>
  );
}
...
function Div26() {
  return (
    <div className="bg-[#f9fafb] h-[116px] relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-2 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-tl-[8px] rounded-tr-[8px]" />
      <div className="content-stretch flex flex-col items-start justify-between px-[16px] py-[25px] relative size-full">
        <Div24 />
        <Div25 />
      </div>
    </div>
      ...
      <div className="relative shrink-0 size-[15px]" data-name="Icon">
        <div className="absolute inset-[-5.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6 16.6">
            <path d={svgPaths.p35d2c400} id="Icon" stroke="var(--stroke-0, #8228E5)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6" />
          </svg>
        </div>
      </div>
      <div className="css-g0mm18 flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8228e5] text-[14px] tracking-[-0.5px]">
        <p className="css-ew64yg leading-[normal]">{`10:00 AM `}</p>
      </div>
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0">
      <div className="h-[15px] relative shrink-0 w-[12px]" data-name="icon">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 15">
          <path d={svgPaths.p377ca800} fill="var(--fill-0, #8228E5)" id="icon" />
        </svg>
      </div>
      <div className="css-g0mm18 flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#8228e5] text-[14px] tracking-[-0.5px]">
        <p className="css-ew64yg leading-[normal]">Cebu City, Philippines</p>
      </div>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[7px] items-start min-h-px min-w-px relative">
      <div className="css-g0mm18 flex flex-col font-['Inter:Extra_Bold',sans-serif] font-extrabold justify-center leading-[0] not-italic relative shrink-0 text-[#8228e5] text-[20px] tracking-[-0.5px]">
        <p className="css-ew64yg leading-[normal]">AI in Business Conference</p>
      </div>
      <Frame18 />
    </div>
  );
...
function Span() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center px-[14px] py-[6px] relative rounded-[4px] shrink-0" data-name="span">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#8228e5] text-[14px] text-center tracking-[-0.5px]">Business</p>
    </div>
  );
}
...
function Div27() {
  return (
    <div className="bg-[rgba(0,0,0,0)] content-stretch flex gap-[7px] items-start justify-end relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <Frame19 />
      <Span />
    </div>
...
function Div28() {
  return (
    <div className="bg-[#f3e7ff] content-stretch flex flex-col h-[90px] items-start justify-center p-[15px] relative rounded-[12px] shrink-0 w-[1086px]" data-name="div">
      <div aria-hidden="true" className="absolute border-[#e9d4ff] border-l-5 border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
      <Div27 />
    </div>
  );
}
...
function Div29() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] content-stretch flex flex-col items-center px-0 py-[25px] relative shrink-0 w-full" data-name="div">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-2 border-l-2 border-r-2 border-solid inset-0 pointer-events-none" />
      <Div28 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1132.07px]">
      <Div26 />
      <Div29 />
    </div>
  );
