...
function ArticleDetailsContent() {
    ...
    useEffect(() => {
        const fetchArticle = async () => {
            ...
            try {
                ...
                if (isEditor && articleData.status === 'deleted') {
    ...
    if (!article) return (
        <div className="p-20 text-center">
            ...
            <button onClick={() => router.push('/admin/articles')} className="text-[#1428AE] hover:underline">
                Back to Articles
            </button>
        </div>
    );
                    ...
                    <aside className="w-[320px] flex-shrink-0 space-y-6">
                        ...
                        <div className="bg-white rounded-[12px] border border-[#e5e7eb] p-6 shadow-sm">
                            ...
                            <div className="space-y-3">
                                ...
                                {article.status === 'published' && !isEditor && (
                                    <button
